...
function Strategy(options, verify) {
    options = options || {};
    options.authorizationEndpoint = options.authorizationEndpoint || 'https://ims-na1.adobelogin.com';
    options.authorizationURL = options.authorizationURL || options.authorizationEndpoint + '/ims/authorize/v1';
    options.tokenURL = options.tokenURL || options.authorizationEndpoint + '/ims/token/v1';
    options.profileURL = options.profileURL || options.authorizationEndpoint + '/ims/profile/v1';
